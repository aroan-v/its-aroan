...
function StyledAnchor({ url, mode }) {
  if (!url || !mode) {
    return
  }
  ...
  return (
    <UnstyledButton
      ...
      className={cn(
        //  Layout & Positioning
        'group/anchor relative inline-flex items-center justify-center',
        'before:absolute before:bottom-[-20%] before:left-1/2 before:z-[0]',

        // Sizing
        'h-10 rounded-md border-0',
        'before:h-[20%] before:w-[100%]',

        // Children Selection
        '[&>a]:h-full [&>a]:w-full [&>a]:px-4 [&>a]:py-2',
        // Text & Spacing
        ...
        //  Pseudo-element (rainbow glow strip)
        'before:-translate-x-1/2',
        'before:bg-[linear-gradient(90deg,hsl(0,100%,63%),hsl(30,100%,63%),hsl(0,100%,63%),hsl(330,100%,63%),hsl(30,100%,63%))]',
        ...
        {mode === 'live' && (
          <>
            <svg
              ...
              viewBox="0 0 256 256"
            >
              <path d="M208,32H48A16,16,0,0,0,32,48V208a16,16,0,0,0,16,16H208a16,16,0,0,0,16-16V48A16,16,0,0,0,208,32ZM168,144a8,8,0,0,1-16,0V115.31l-50.34,50.35a8,8,0,0,1-11.32-11.32L140.69,104H112a8,8,0,0,1,0-16h48a8,8,0,0,1,8,8Z"></path>
            </svg>
            Live Demo
          </>
        )}
